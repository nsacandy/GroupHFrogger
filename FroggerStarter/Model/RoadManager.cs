...
namespace FroggerStarter.Model
{
    ...
    public class RoadManager : IEnumerable<Vehicle>
    {
        ...
        {
            lanes = new List<Lane>();
            laneWidth = backgroundWidth;
            setLevelOneLaneValues();
        }
        ...
        {
            setLaneOneLevelThree();
            setLaneTwoLevelThree();
            setLaneThreeLevelThree();
            setLaneFourLevelThree();
            setLaneFiveLevelThree();
        }

        private void setLaneOneLevelOne()
        {
            var laneOne =
                new Lane(GameSettings.LaneOneLevelOneValues[0], GameSettings.LaneOneLevelOneValues[1],
                    VehicleFactory.VehicleType.Car, Lane.Direction.Left, true)
                {
        ...
        {
            var laneTwo =
                new Lane(GameSettings.LaneTwoLevelOneValues[0], GameSettings.LaneTwoLevelOneValues[1],
                    VehicleFactory.VehicleType.SportsCar, Lane.Direction.Right, true)
                {
        ...
        {
            var laneThree =
                new Lane(GameSettings.LaneThreeLevelOneValues[0], GameSettings.LaneThreeLevelOneValues[1],
                    VehicleFactory.VehicleType.Car, Lane.Direction.Left, true)
                {
        ...
        {
            var laneFour =
                new Lane(GameSettings.LaneFourLevelOneValues[0], GameSettings.LaneFourLevelOneValues[1],
                    VehicleFactory.VehicleType.Truck, Lane.Direction.Left, true)
                {
        ...
        {
            var laneFive =
                new Lane(GameSettings.LaneFiveLevelOneValues[0], GameSettings.LaneFiveLevelOneValues[1],
                    VehicleFactory.VehicleType.Car, Lane.Direction.Right, true)
                {
        ...
        {
            var laneOne =
                new Lane(GameSettings.LaneOneLevelTwoValues[0], GameSettings.LaneOneLevelTwoValues[1],
                    VehicleFactory.VehicleType.Car, Lane.Direction.Left, true)
                {
        ...
        {
            var laneTwo =
                new Lane(GameSettings.LaneTwoLevelTwoValues[0], GameSettings.LaneTwoLevelTwoValues[1],
                    VehicleFactory.VehicleType.SportsCar, Lane.Direction.Right, true)
                {
        ...
        {
            var laneThree =
                new Lane(GameSettings.LaneThreeLevelTwoValues[0], GameSettings.LaneThreeLevelTwoValues[1],
                    VehicleFactory.VehicleType.Car, Lane.Direction.Left, true)
                {
        ...
        {
            var laneFour =
                new Lane(GameSettings.LaneFourLevelTwoValues[0], GameSettings.LaneFourLevelTwoValues[1],
                    VehicleFactory.VehicleType.Truck, Lane.Direction.Left, true)
                {
        ...
        {
            var laneFive =
                new Lane(GameSettings.LaneFiveLevelTwoValues[0], GameSettings.LaneFiveLevelTwoValues[1],
                    VehicleFactory.VehicleType.Car, Lane.Direction.Right, true)
                {
        ...
        {
            var laneOne =
                new Lane(GameSettings.LaneOneLevelThreeValues[0], GameSettings.LaneOneLevelThreeValues[1],
                    VehicleFactory.VehicleType.Car, Lane.Direction.Left, true)
                {
        ...
        {
            var laneTwo =
                new Lane(GameSettings.LaneTwoLevelThreeValues[0], GameSettings.LaneTwoLevelThreeValues[1],
                    VehicleFactory.VehicleType.SportsCar, Lane.Direction.Right, true)
                {
        ...
        {
            var laneThree =
                new Lane(GameSettings.LaneThreeLevelThreeValues[0], GameSettings.LaneThreeLevelThreeValues[1],
                    VehicleFactory.VehicleType.Car, Lane.Direction.Left, true)
                {
        ...
        {
            var laneFour =
                new Lane(GameSettings.LaneFourLevelThreeValues[0], GameSettings.LaneFourLevelThreeValues[1],
                    VehicleFactory.VehicleType.Truck, Lane.Direction.Left, true)
                {
        ...
        {
            var laneFive =
                new Lane(GameSettings.LaneFiveLevelThreeValues[0], GameSettings.LaneFiveLevelThreeValues[1],
                    VehicleFactory.VehicleType.Car, Lane.Direction.Right, true)
                {
        ...
        {
            foreach (var lane in lanes) lane.MoveVehiclesOnTick();
        }

        public void resetNumVehicles()
        {
            foreach (var lane in lanes) lane.HideVehicles();
        }

        public void CollapseAllVehicles()
        {
            foreach (var lane in lanes) lane.CollapseAllVehicles();
        }
